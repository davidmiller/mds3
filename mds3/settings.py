# Django settings for mds3 project.
import commands
import os
import sys
...
SECRET_KEY = '70tt80*^=y8z(q7)vcuev&#j#ou7(n_1=i_0fq3@0!y#_ms$y+'
...
ROOT_URLCONF = 'mds3.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mds3.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('mds3.migrations', 'mds3.tests',
                            'mds3.local_settings',
